const ProjectItem = ({ eachProject }) => {
  const technologies = eachProject.technologies.map((eachTechnology) => (
    <p className="project__tecn">{eachTechnology}</p>
  ));
    ...
    <div className="project">
      ...
      <div className="project__row">
        ...
        <div className="project__container">
          <a href={eachProject.repo} Target="_blank">
            <i className="fa-brands fa-square-github project__icons"></i>
          </a>
          <a href={eachProject.demo} Target="_blank">
            <i class="fa-solid fa-arrow-up-right-from-square project__icons"></i>
          </a>
        </div>
      </div>
